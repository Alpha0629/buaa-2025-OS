 ...
 *	* ---------------------------------*
 */
static inline int is_illegal_dev_range(u_long pa, u_int len) {
 	if ((pa % 4 != 0 && len == 4) || (pa % 2 != 0 && len != 1)) return 1;

	if ((pa >= 0x180001f0) && (pa + len <= 0x180001f0 + 0x8)) return 0;

	if ((pa >= 0x180003f8) && (pa + len <= 0x180003f8 + 0x20)) return 0;
